                  ...
                  <div class="col-md-4">
                    <div class="card">
                                  <div class="card-body text-center">
                                      <h3 class="card-title text-center"><b>Daily Report</b></h3>
                                      <a href="commonreport.php?daily" class="btn btn-primary">Next</a>
                                  </div>
                              </div>
                  </div>
                  <div class="col-md-4">
                    <div class="card">
                                  <div class="card-body text-center">
                                      <h3 class="card-title text-center"><b>Monthly Report</b></h3>
                                      <a href="commonreport.php?month" class="btn btn-primary">Next</a>
                                  </div>
                              </div>
                  </div>
                  <div class="col-md-4">
                    <div class="card">
                                  <div class="card-body text-center">
                                      <h3 class="card-title text-center"><b>Yearly Report</b></h3>
                                      <a href="commonreport.php?year" class="btn btn-primary">Next</a>
                                  </div>
                              </div>
                  </div>
                </div>
